...
export const APP_NAME = "Yatra AI";

export const CATEGORIES = [
  "Hill Station", "Beach", "Spiritual", "Heritage", "Adventure", "Metropolis", "Backwaters", "Wildlife"
];

export const INTEREST_OPTIONS = [
  "Trekking", "Street Food", "Temples", "Luxury Stays", "Nightlife", "History", 
  "Ayurveda", "Shopping", "Festivals", "Wellness", "Photography", "Wildlife",
  "Architecture", "Yoga", "Beaches", "Mountains"
];
...
InfoSquare: () => (
 <svg
    ...
    <path strokeLinecap="round" strokeLinejoin="round" d="M5 7h-1M5 11h-1M5 15h-1" />
  </svg>
),
