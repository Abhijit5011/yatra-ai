        ...
        responseSchema: {
          ...
          properties: {
            ...
            stay_options: {
              ...
              items: {
                type: Type.OBJECT,
                properties: { name: { type: Type.STRING }, type: { type: Type.STRING }, price_range: { type: Type.STRING }, booking_url: { type: Type.STRING } },
            ...
            food_gems: {
              ...
              items: {
                type: Type.OBJECT,
                properties: { name: { type: Type.STRING }, specialty: { type: Type.STRING }, price_level: { type: Type.STRING }, maps_url: { type: Type.STRING } },
            ...
            days: {
              ...
              items: {
                ...
                properties: {
                  ...
                  morning: { 
                    type: Type.OBJECT, 
                    properties: { activity: { type: Type.STRING }, details: { type: Type.ARRAY, items: { type: Type.STRING } }, location_name: { type: Type.STRING }, google_maps_url: { type: Type.STRING }, official_website_url: { type: Type.STRING } },
                  ...
                  travel_segments: {
                    ...
                    items: {
                      type: Type.OBJECT,
                      properties: { from: { type: Type.STRING }, to: { type: Type.STRING }, mode: { type: Type.STRING }, duration: { type: Type.STRING }, cost_estimate: { type: Type.STRING } },
